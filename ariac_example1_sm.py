...
class ariac_exampleSM(Behavior):
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['Shipments', 'NumberOfShipments', 'Products', 'NumberOfProducts'])
		...
		with _state_machine:
			...
			OperatableStateMachine.add('GetPart',
										...
										transitions={'continue': 'GetPartLocation', 'invalid_index': 'failed'},
			...
			OperatableStateMachine.add('GetPartLocation',
										...
										autonomy={'continue': Autonomy.Off},
										remapping={'part': 'part', 'material_locations': 'MaterialsLocationList'})
			...
			OperatableStateMachine.add('LookupCameraFrame',
										LookupFromTableState(parameter_name='/ariac_unit1_tables', table_name='bin_configuration', index_title='bin', column_title='camera_frame'),
										transitions={'found': 'LookupPreGrasp', 'not_found': 'failed'},
										autonomy={'found': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'index_value': 'MaterialLocationIndex', 'column_value': 'camera_frame'})

			# x:1031 y:81
			OperatableStateMachine.add('LookupCameraTopic',
										LookupFromTableState(parameter_name='/ariac_unit1_tables', table_name='bin_configuration', index_title='bin', column_title='camera_topic'),
										transitions={'found': 'LookupCameraFrame', 'not_found': 'failed'},
										autonomy={'found': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'index_value': 'MaterialLocationIndex', 'column_value': 'camera_topic'})

			# x:1028 y:222
			OperatableStateMachine.add('LookupPreGrasp',
										LookupFromTableState(parameter_name='/ariac_unit1_tables', table_name='bin_configuration', index_title='bin', column_title='robot_config'),
			...
			OperatableStateMachine.add('MoveR1Home',
										...
										transitions={'reached': 'GetOrder', 'planning_failed': 'WaitRetry1', 'control_failed': 'WaitRetry1', 'param_error': 'failed'},
