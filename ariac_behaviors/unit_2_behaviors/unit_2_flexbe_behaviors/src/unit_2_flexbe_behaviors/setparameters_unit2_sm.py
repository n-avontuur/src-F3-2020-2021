...
from unit_2_flexbe_behaviors.assambly_ready_sm import assambly_readySM
...
class setParameters_unit2SM(Behavior):
	...
	def create(self):
		...
		with _state_machine:
			...
			# x:1274 y:74
			OperatableStateMachine.add('addAssembly',
										AddNumericState(),
			...
			OperatableStateMachine.add('findPartOnAGV1',
										...
										transitions={'continue': 'getCasePose', 'failed': 'failed', 'not_found': 'findPartOnAGV1_2'},
