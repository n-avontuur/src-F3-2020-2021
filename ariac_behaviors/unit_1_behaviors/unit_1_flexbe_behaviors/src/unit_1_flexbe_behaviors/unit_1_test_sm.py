	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('place_part_on_agv',
										...
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit},
										remapping={'ProductType': 'ProductType', 'ProductIterator': 'ProductIterator', 'action_topic_namespace': 'action_topic_namespace', 'traypredrop': 'traypredrop', 'tray': 'tray', 'move_group': 'move_group'})
