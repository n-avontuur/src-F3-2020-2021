...
class unit_1_FINALESM(Behavior):
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['number_of_kitting_shipments', 'kitting_shipments', 'kitting_index'], output_keys=['kitting_index'])
