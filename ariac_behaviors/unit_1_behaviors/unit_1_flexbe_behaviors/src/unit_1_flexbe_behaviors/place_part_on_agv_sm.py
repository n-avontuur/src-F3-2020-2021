...
class place_part_on_agvSM(Behavior):
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['ProductType', 'ProductIterator', 'action_topic_namespace', 'traypredrop', 'tray', 'move_group'])
		...
		with _state_machine:
			...
			OperatableStateMachine.add('GetAgvPose',
										GetObjectPoseState(),
										transitions={'continue': 'equal position', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
			...
			# x:367 y:416
			OperatableStateMachine.add('create position',
			...
			# x:367 y:508
			OperatableStateMachine.add('create position_2',
			...
			# x:367 y:600
			OperatableStateMachine.add('create position_3',
										CreatePoseState(xyz=[0.2,0,0], rpy=[0,0,0]),
										transitions={'continue': 'offsetagvpose', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'pose': 'pose_offset'})
			...
			# x:162 y:419
			OperatableStateMachine.add('equal position',
										EqualState(),
										transitions={'true': 'create position', 'false': 'equal position_2'},
										autonomy={'true': Autonomy.Off, 'false': Autonomy.Off},
										remapping={'value_a': 'ProductIterator', 'value_b': 'part_count_0'})

			# x:162 y:515
			OperatableStateMachine.add('equal position_2',
										EqualState(),
										transitions={'true': 'create position_2', 'false': 'equal position_3'},
										autonomy={'true': Autonomy.Off, 'false': Autonomy.Off},
										remapping={'value_a': 'ProductIterator', 'value_b': 'part_count_1'})

			# x:162 y:607
			OperatableStateMachine.add('equal position_3',
										EqualState(),
										transitions={'true': 'create position_3', 'false': 'failed'},
										autonomy={'true': Autonomy.Off, 'false': Autonomy.Off},
										remapping={'value_a': 'ProductIterator', 'value_b': 'part_count_2'})
			...
			OperatableStateMachine.add('offsetagvpose',
										...
										remapping={'input_pose': 'agv_pose', 'offset_pose': 'pose_offset', 'output_pose': 'agv_pose'})
