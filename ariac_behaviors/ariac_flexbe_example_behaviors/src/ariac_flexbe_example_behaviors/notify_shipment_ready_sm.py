...
This is a part of the ariac_example.
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['agv_id', 'station_id', 'shipment_type', 'assembly_station_name'])
		...
		with _state_machine:
			# x:181 y:28
			OperatableStateMachine.add('notify kitting ready',
										NotifyKittingShipmentState(),
										transitions={'continue': 'Wait', 'fail': 'failed', 'service_timeout': 'failed'},
