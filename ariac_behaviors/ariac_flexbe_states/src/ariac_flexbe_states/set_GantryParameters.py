...
class set_GantryParameters(EventState):
	...
	def __init__(self):
		super(set_GantryParameters,self).__init__(input_keys = ['station_id'],outcomes = ['continue', 'failed'], output_keys = ['home_Pose','table_Pose','section_Pose','gantry_move_group','gantry_action_topic_namespace','gantry_action_topic','robot_name','camera_frame1','camera_topic1','camera_frame2','camera_topic2','first_agv','sec_agv'])
